...
@
@#######################################################################
@# EmPy template for generating <idl>__rosidl_typesupport_fastrtps_c_impl.hpp files
@#
@# Context:
@#  - package_name (string)
...
header_guard_variable = '__'.join([x.upper() for x in include_parts]) + \
    '__ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPL_HPP_'
...
@{
TEMPLATE(
    'srv__type_support_c_impl.hpp.em',
